...
export function DropdownActions({ automaker }: { automaker: Automaker }) {
      ...
      <DialogContent>
        {component == "update" ? (
          <DialogHeader>
            ...
            <CreateAutomakerForm data={automaker} hideDialog={hideDialog} />
          </DialogHeader>
        ) : (
          <DialogDelete automaker={automaker} hideDialog={hideDialog} />
        )}
      </DialogContent>
    </Dialog>
  );
